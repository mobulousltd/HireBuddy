...
public class CircleImageView extends ImageView {
	...
	private static final int DEFAULT_BORDER_COLOR = R.color.yellow;
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderColor = a.getColor(R.styleable.CircleImageView_civ_border_color, getResources().getColor(R.color.yellow));
